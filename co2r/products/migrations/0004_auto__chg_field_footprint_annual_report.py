...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Footprint.annual_report'
        db.alter_column('products_footprint', 'annual_report', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Footprint.annual_report'
        raise RuntimeError("Cannot reverse this migration. 'Footprint.annual_report' and its values cannot be restored.")
    ...
    models = {
        ...
        'products.product': {
            ...
            'unit_quantity': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
