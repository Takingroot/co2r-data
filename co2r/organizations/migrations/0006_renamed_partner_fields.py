...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Organization.partnership_description'
        db.add_column('organizations_organization', 'partnership_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Organization.partnership_description_fr'
        db.add_column('organizations_organization', 'partnership_description_fr',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Organization.partnership_description'
        db.delete_column('organizations_organization', 'partnership_description')

        # Deleting field 'Organization.partnership_description_fr'
        db.delete_column('organizations_organization', 'partnership_description_fr')
