...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organization.widget_code'
        db.add_column(u'organizations_organization', 'widget_code',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Organization.widget_code_fr'
        db.add_column(u'organizations_organization', 'widget_code_fr',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organization.widget_code'
        db.delete_column(u'organizations_organization', 'widget_code')

        # Deleting field 'Organization.widget_code_fr'
        db.delete_column(u'organizations_organization', 'widget_code_fr')
    ...
    models = {
        ...
        u'organizations.organization': {
            ...
            'widget_code': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'widget_code_fr': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})
        }
    }
