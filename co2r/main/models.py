...
class Locale(models.Model):
    ...
    directory_nav_text_description = models.TextField(blank=True, null=True)
    directory_action_title_one = models.CharField(max_length=100, blank=True, null=True)
    directory_action_body_one = models.TextField(blank=True, null=True)
    directory_action_title_two = models.CharField(max_length=100, blank=True, null=True)
    directory_action_body_two = models.TextField(blank=True, null=True)
    directory_action_title_three = models.CharField(max_length=100, blank=True, null=True)
    directory_action_body_three = models.TextField(blank=True, null=True)
    faq = models.CharField(max_length=100, blank=True, null=True)
    faq_nav_text_description = models.TextField(blank=True, null=True)
    register_your_product = models.CharField(max_length=100, blank=True, null=True, help_text='Supports Html')
    register_your_product_nav_text_description = models.TextField(blank=True, null=True)
    participate = models.CharField(max_length=100, blank=True, null=True, verbose_name='Can Do Nav Text')
    participate_nav_text_description = models.TextField(blank=True, null=True)
    ...
    can_do_feedback_button_label = models.TextField(blank=True, null=True, help_text='Supports Html')
    ...
    can_do_spread_word_button_label = models.TextField(blank=True, null=True, help_text='Supports Html')
    ...
    can_do_recruit_company_button_label = models.TextField(blank=True, null=True, help_text='Supports Html')
    ...
    can_do_sponsor_co2r_button_label = models.TextField(blank=True, null=True, help_text='Supports Html')
    ...
    about_carbon_farmers_title = models.CharField(max_length=100, blank=True, null=True, help_text='Supports Html and co2r-tags')
    about_carbon_farmers_text = models.TextField(blank=True, null=True, help_text='Supports Html and co2r-tags')
    social_bar_text = models.CharField(max_length=100, blank=True, null=True)
    social_bar_artifact_text = models.CharField(max_length=100, blank=True, null=True)
