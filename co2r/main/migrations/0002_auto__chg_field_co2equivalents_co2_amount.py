...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Co2Equivalents.co2_amount'
        db.alter_column('main_co2equivalents', 'co2_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=2))

    models = {
        'main.co2equivalents': {
            'Meta': {'object_name': 'Co2Equivalents'},
            'co2_amount': ('django.db.models.fields.DecimalField', [], {'max_digits': '14', 'decimal_places': '6'}),
