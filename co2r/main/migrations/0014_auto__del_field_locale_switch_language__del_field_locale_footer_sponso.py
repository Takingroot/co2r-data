...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Locale.footer_sponsor_description'
        db.delete_column('main_locale', 'footer_sponsor_description')

        # Deleting field 'Locale.footer_taking_root'
        db.delete_column('main_locale', 'footer_taking_root')

        # Deleting field 'Locale.footer_taking_root_description'
        db.delete_column('main_locale', 'footer_taking_root_description')

        # Deleting field 'Locale.footer_sponsor_name'
        db.delete_column('main_locale', 'footer_sponsor_name')

        # Deleting field 'Locale.footer_sponsor_link'
        db.delete_column('main_locale', 'footer_sponsor_link')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Locale.footer_sponsor_description'
        db.add_column('main_locale', 'footer_sponsor_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Locale.footer_taking_root'
        db.add_column('main_locale', 'footer_taking_root',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Locale.footer_taking_root_description'
        db.add_column('main_locale', 'footer_taking_root_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Locale.footer_sponsor_name'
        db.add_column('main_locale', 'footer_sponsor_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Locale.footer_sponsor_link'
        db.add_column('main_locale', 'footer_sponsor_link',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)
