...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Locale.heroshot_home'
        db.add_column('main_locale', 'heroshot_home',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Locale.heroshot_mission'
        db.add_column('main_locale', 'heroshot_mission',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Locale.mission_map_help_tip'
        db.add_column('main_locale', 'mission_map_help_tip',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Locale.directory'
        db.add_column('main_locale', 'directory',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Locale.directory_action_title_one'
        db.add_column('main_locale', 'directory_action_title_one',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Locale.directory_action_body_one'
        db.add_column('main_locale', 'directory_action_body_one',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Locale.directory_action_title_two'
        db.add_column('main_locale', 'directory_action_title_two',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Locale.directory_action_body_two'
        db.add_column('main_locale', 'directory_action_body_two',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Locale.directory_action_title_three'
        db.add_column('main_locale', 'directory_action_title_three',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Locale.directory_action_body_three'
        db.add_column('main_locale', 'directory_action_body_three',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Locale.social_bar_text'
        db.add_column('main_locale', 'social_bar_text',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Locale.heroshot_home'
        db.delete_column('main_locale', 'heroshot_home')

        # Deleting field 'Locale.heroshot_mission'
        db.delete_column('main_locale', 'heroshot_mission')

        # Deleting field 'Locale.mission_map_help_tip'
        db.delete_column('main_locale', 'mission_map_help_tip')

        # Deleting field 'Locale.directory'
        db.delete_column('main_locale', 'directory')

        # Deleting field 'Locale.directory_action_title_one'
        db.delete_column('main_locale', 'directory_action_title_one')

        # Deleting field 'Locale.directory_action_body_one'
        db.delete_column('main_locale', 'directory_action_body_one')

        # Deleting field 'Locale.directory_action_title_two'
        db.delete_column('main_locale', 'directory_action_title_two')

        # Deleting field 'Locale.directory_action_body_two'
        db.delete_column('main_locale', 'directory_action_body_two')

        # Deleting field 'Locale.directory_action_title_three'
        db.delete_column('main_locale', 'directory_action_title_three')

        # Deleting field 'Locale.directory_action_body_three'
        db.delete_column('main_locale', 'directory_action_body_three')

        # Deleting field 'Locale.social_bar_text'
        db.delete_column('main_locale', 'social_bar_text')
