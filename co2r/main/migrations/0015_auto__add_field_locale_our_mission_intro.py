...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Locale.our_mission_intro'
        db.add_column(u'main_locale', 'our_mission_intro',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Locale.our_mission_intro'
        db.delete_column(u'main_locale', 'our_mission_intro')
