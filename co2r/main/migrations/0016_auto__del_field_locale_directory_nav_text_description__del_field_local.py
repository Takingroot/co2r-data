...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Locale.directory_nav_text_description'
        db.delete_column(u'main_locale', 'directory_nav_text_description')

        # Deleting field 'Locale.faq_nav_text_description'
        db.delete_column(u'main_locale', 'faq_nav_text_description')

        # Deleting field 'Locale.register_your_product_nav_text_description'
        db.delete_column(u'main_locale', 'register_your_product_nav_text_description')

        # Deleting field 'Locale.our_mission_nav_text_description'
        db.delete_column(u'main_locale', 'our_mission_nav_text_description')

        # Deleting field 'Locale.participate_nav_text_description'
        db.delete_column(u'main_locale', 'participate_nav_text_description')

        # Adding field 'Locale.artifact_organization_label'
        db.add_column(u'main_locale', 'artifact_organization_label',
                      self.gf('django.db.models.fields.CharField')(default='Organization', max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Locale.directory_nav_text_description'
        db.add_column(u'main_locale', 'directory_nav_text_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Locale.faq_nav_text_description'
        db.add_column(u'main_locale', 'faq_nav_text_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Locale.register_your_product_nav_text_description'
        db.add_column(u'main_locale', 'register_your_product_nav_text_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Locale.our_mission_nav_text_description'
        db.add_column(u'main_locale', 'our_mission_nav_text_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Locale.participate_nav_text_description'
        db.add_column(u'main_locale', 'participate_nav_text_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Locale.artifact_organization_label'
        db.delete_column(u'main_locale', 'artifact_organization_label')


    models = {
        u'main.co2equivalents': {
        ...
        u'main.locale': {
            ...
            'artifact_organization_label': ('django.db.models.fields.CharField', [], {'default': "'Organization'", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
            ...
            'footer_partners_title': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            ...
            'our_mission_intro': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
