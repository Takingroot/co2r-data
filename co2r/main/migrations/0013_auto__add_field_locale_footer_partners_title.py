...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Locale.footer_partners_title'
        db.add_column('main_locale', 'footer_partners_title',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Locale.footer_partners_title'
        db.delete_column('main_locale', 'footer_partners_title')
