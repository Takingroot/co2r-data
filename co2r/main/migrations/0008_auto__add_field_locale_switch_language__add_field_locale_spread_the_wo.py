...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Locale.switch_language'
        db.add_column('main_locale', 'switch_language',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Locale.spread_the_word_default_message'
        db.add_column('main_locale', 'spread_the_word_default_message',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Locale.spread_the_word_button_label'
        db.add_column('main_locale', 'spread_the_word_button_label',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Locale.register_artifact_left_column'
        db.add_column('main_locale', 'register_artifact_left_column',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Locale.register_artifact_right_body'
        db.add_column('main_locale', 'register_artifact_right_body',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Locale.artifact_share_default_message'
        db.add_column('main_locale', 'artifact_share_default_message',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Locale.switch_language'
        db.delete_column('main_locale', 'switch_language')

        # Deleting field 'Locale.spread_the_word_default_message'
        db.delete_column('main_locale', 'spread_the_word_default_message')

        # Deleting field 'Locale.spread_the_word_button_label'
        db.delete_column('main_locale', 'spread_the_word_button_label')

        # Deleting field 'Locale.register_artifact_left_column'
        db.delete_column('main_locale', 'register_artifact_left_column')

        # Deleting field 'Locale.register_artifact_right_body'
        db.delete_column('main_locale', 'register_artifact_right_body')

        # Deleting field 'Locale.artifact_share_default_message'
        db.delete_column('main_locale', 'artifact_share_default_message')
