...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Locale.can_do_feedback_button_label'
        db.add_column('main_locale', 'can_do_feedback_button_label',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Locale.can_do_spread_word_button_label'
        db.add_column('main_locale', 'can_do_spread_word_button_label',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Locale.can_do_recruit_company_button_label'
        db.add_column('main_locale', 'can_do_recruit_company_button_label',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Locale.can_do_sponsor_co2r_button_label'
        db.add_column('main_locale', 'can_do_sponsor_co2r_button_label',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Locale.about_carbon_farmers_title'
        db.add_column('main_locale', 'about_carbon_farmers_title',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Locale.about_carbon_farmers_text'
        db.add_column('main_locale', 'about_carbon_farmers_text',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Locale.can_do_feedback_button_label'
        db.delete_column('main_locale', 'can_do_feedback_button_label')

        # Deleting field 'Locale.can_do_spread_word_button_label'
        db.delete_column('main_locale', 'can_do_spread_word_button_label')

        # Deleting field 'Locale.can_do_recruit_company_button_label'
        db.delete_column('main_locale', 'can_do_recruit_company_button_label')

        # Deleting field 'Locale.can_do_sponsor_co2r_button_label'
        db.delete_column('main_locale', 'can_do_sponsor_co2r_button_label')

        # Deleting field 'Locale.about_carbon_farmers_title'
        db.delete_column('main_locale', 'about_carbon_farmers_title')

        # Deleting field 'Locale.about_carbon_farmers_text'
        db.delete_column('main_locale', 'about_carbon_farmers_text')
