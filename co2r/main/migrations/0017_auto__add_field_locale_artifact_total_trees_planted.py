...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Locale.artifact_total_trees_planted'
        db.add_column(u'main_locale', 'artifact_total_trees_planted',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Locale.artifact_total_trees_planted'
        db.delete_column(u'main_locale', 'artifact_total_trees_planted')
    ...
    models = {
        ...
        u'main.locale': {
            ...
            'artifact_total_trees_planted': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
