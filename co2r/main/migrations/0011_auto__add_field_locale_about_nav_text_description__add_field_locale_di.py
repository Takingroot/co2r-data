...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_locale', 'directory_nav_text_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Locale.faq_nav_text_description'
        db.add_column('main_locale', 'faq_nav_text_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Locale.register_your_product_nav_text_description'
        db.add_column('main_locale', 'register_your_product_nav_text_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Locale.artifact_no_data'
        db.add_column('main_locale', 'artifact_no_data',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Locale.social_bar_artifact_text'
        db.add_column('main_locale', 'social_bar_artifact_text',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Locale.branding_subtext'
        db.add_column('main_locale', 'branding_subtext',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('main_locale', 'directory_nav_text_description')

        # Deleting field 'Locale.faq_nav_text_description'
        db.delete_column('main_locale', 'faq_nav_text_description')

        # Deleting field 'Locale.register_your_product_nav_text_description'
        db.delete_column('main_locale', 'register_your_product_nav_text_description')

        # Deleting field 'Locale.can_do_nav_text_description'
        db.delete_column('main_locale', 'can_do_nav_text_description')

        # Deleting field 'Locale.artifact_no_data'
        db.delete_column('main_locale', 'artifact_no_data')

        # Deleting field 'Locale.social_bar_artifact_text'
        db.delete_column('main_locale', 'social_bar_artifact_text')

        # Deleting field 'Locale.branding_subtext'
        db.delete_column('main_locale', 'branding_subtext')
    ...
    models = {
        ...
        'main.locale': {
            ...
            'about_nav_text_description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'can_do_nav_text_description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
