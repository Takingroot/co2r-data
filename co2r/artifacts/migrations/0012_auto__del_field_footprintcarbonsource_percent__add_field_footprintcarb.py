...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FootprintCarbonSource.percent'
        db.delete_column('artifacts_footprintcarbonsource', 'percent')

        # Adding field 'FootprintCarbonSource.co2_amount_tons'
        db.add_column('artifacts_footprintcarbonsource', 'co2_amount_tons',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'FootprintCarbonSource.percent'
        raise RuntimeError("Cannot reverse this migration. 'FootprintCarbonSource.percent' and its values cannot be restored.")
        # Deleting field 'FootprintCarbonSource.co2_amount_tons'
        db.delete_column('artifacts_footprintcarbonsource', 'co2_amount_tons')
