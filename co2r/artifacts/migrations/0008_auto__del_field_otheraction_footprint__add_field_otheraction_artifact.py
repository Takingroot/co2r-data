...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OtherAction.artifact'
        db.add_column('artifacts_otheraction', 'artifact',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['artifacts.Artifact']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'OtherAction.footprint'
        raise RuntimeError("Cannot reverse this migration. 'OtherAction.footprint' and its values cannot be restored.")
