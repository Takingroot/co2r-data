...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OtherAction.artifact'
        db.delete_column('artifacts_otheraction', 'artifact_id')

        # Adding field 'OtherAction.footprint'
        db.add_column('artifacts_otheraction', 'footprint',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['artifacts.Footprint']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'OtherAction.artifact'
        raise RuntimeError("Cannot reverse this migration. 'OtherAction.artifact' and its values cannot be restored.")
        # Deleting field 'OtherAction.footprint'
        db.delete_column('artifacts_otheraction', 'footprint_id')
