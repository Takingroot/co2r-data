...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('artifacts_artifact', (
            ...
            ('unit_verbose_fr', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
        ...
        db.create_table('artifacts_footprint', (
            ...
            ('annual_report_fr', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
        ))
