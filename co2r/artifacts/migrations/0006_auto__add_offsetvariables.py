...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OffsetVariables'
        db.create_table('artifacts_offsetvariables', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('year', self.gf('django.db.models.fields.IntegerField')(unique=True)),
            ('offsets_per_co2_ton', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('trees_per_offset', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ))
        db.send_create_signal('artifacts', ['OffsetVariables'])


    def backwards(self, orm):
        # Deleting model 'OffsetVariables'
        db.delete_table('artifacts_offsetvariables')
