...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Artifact.for_total_made'
        db.add_column('artifacts_artifact', 'for_total_made',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Artifact.for_total_made_fr'
        db.add_column('artifacts_artifact', 'for_total_made_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Footprint.ton_offset_per_tree'
        db.delete_column('artifacts_footprint', 'ton_offset_per_tree')


    def backwards(self, orm):
        # Deleting field 'Artifact.for_total_made'
        db.delete_column('artifacts_artifact', 'for_total_made')

        # Deleting field 'Artifact.for_total_made_fr'
        db.delete_column('artifacts_artifact', 'for_total_made_fr')

        # Adding field 'Footprint.ton_offset_per_tree'
        db.add_column('artifacts_footprint', 'ton_offset_per_tree',
