...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OtherActionType'
        db.create_table('artifacts_otheractiontype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('name_fr', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('icon_code', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal('artifacts', ['OtherActionType'])

        # Deleting field 'OtherAction.name_fr'
        db.delete_column('artifacts_otheraction', 'name_fr')

        # Deleting field 'OtherAction.name'
        db.delete_column('artifacts_otheraction', 'name')

        # Adding field 'OtherAction.type'
        db.add_column('artifacts_otheraction', 'type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['artifacts.OtherActionType'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'OtherActionType'
        db.delete_table('artifacts_otheractiontype')


        # User chose to not deal with backwards NULL issues for 'OtherAction.name_fr'
        raise RuntimeError("Cannot reverse this migration. 'OtherAction.name_fr' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'OtherAction.name'
        raise RuntimeError("Cannot reverse this migration. 'OtherAction.name' and its values cannot be restored.")
        # Deleting field 'OtherAction.type'
        db.delete_column('artifacts_otheraction', 'type_id')
